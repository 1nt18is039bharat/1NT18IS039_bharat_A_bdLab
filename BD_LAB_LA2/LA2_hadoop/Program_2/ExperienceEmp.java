...
public class ExperienceEmp {
	...
	public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, Text, IntWritable> {
		...
		public void map(LongWritable key, Text value, OutputCollector<Text, IntWritable> output, Reporter reporter) throws IOException {
			...
			if (count[5].equals("5")) {	
				output.collect(new Text("Number of employees with experience equal to 5 are : "), one);
			}
		...
		public static void main(String[] args) throws Exception {
			JobConf conf = new JobConf(ExperienceEmp.class);
			conf.setJobName("Number of employees with experience equal to 5 are : ");
